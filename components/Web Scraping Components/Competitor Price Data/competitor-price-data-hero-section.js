...
export default function CompetitorPriceDataHeroSection() {
  return (
    <section className="relative overflow-hidden py-20 -mt-12">
      ...
      <div className="relative max-w-9xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          >
            Real-Time Competitive Pricing Data Continuously Updated for Smarter
          ...
          >
            Make informed and strategic pricing decisions with complete
            confidence, powered by precise, timely. Gain unparalleled visibility
            into market trends and respond proactively to pricing
            shifts—ensuring your business remains competitive and profitable at
            all times.
          </motion.p>
